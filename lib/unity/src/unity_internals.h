...
#endif
void UnityPushDetail(UNITY_DETAIL_LABEL_TYPE label, UNITY_DETAIL_VALUE_TYPE value,
                     const UNITY_LINE_TYPE line);
void UnityPopDetail(UNITY_DETAIL_LABEL_TYPE label, UNITY_DETAIL_VALUE_TYPE value,
                    const UNITY_LINE_TYPE line);
...
void UnityAssertEqualIntNumber(const UNITY_INT expected, const UNITY_INT actual, const char* msg,
                               const UNITY_LINE_TYPE lineNumber, const UNITY_DISPLAY_STYLE_T style);

void UnityAssertEqualUintNumber(const UNITY_UINT expected, const UNITY_UINT actual, const char* msg,
                                const UNITY_LINE_TYPE lineNumber,
                                const UNITY_DISPLAY_STYLE_T style);

void UnityAssertIntGreaterOrLessOrEqualNumber(const UNITY_INT threshold, const UNITY_INT actual,
                                              const UNITY_COMPARISON_T compare, const char* msg,
                                              const UNITY_LINE_TYPE lineNumber,
                                              const UNITY_DISPLAY_STYLE_T style);

void UnityAssertUintGreaterOrLessOrEqualNumber(const UNITY_UINT threshold, const UNITY_UINT actual,
                                               const UNITY_COMPARISON_T compare, const char* msg,
                                               const UNITY_LINE_TYPE lineNumber,
                                               const UNITY_DISPLAY_STYLE_T style);
...
void UnityAssertIntNumbersWithin(const UNITY_UINT delta, const UNITY_INT expected,
                                 const UNITY_INT actual, const char* msg,
                                 const UNITY_LINE_TYPE lineNumber,
                                 const UNITY_DISPLAY_STYLE_T style);

void UnityAssertUintNumbersWithin(const UNITY_UINT delta, const UNITY_UINT expected,
...
#define UNITY_TEST_ASSERT_EQUAL_INT(expected, actual, line, message)                 \
    UnityAssertEqualIntNumber((UNITY_INT)(expected), (UNITY_INT)(actual), (message), \
                              (UNITY_LINE_TYPE)(line), UNITY_DISPLAY_STYLE_INT)
#define UNITY_TEST_ASSERT_EQUAL_INT8(expected, actual, line, message)                             \
    UnityAssertEqualIntNumber((UNITY_INT)(UNITY_INT8)(expected), (UNITY_INT)(UNITY_INT8)(actual), \
...
#define UNITY_TEST_ASSERT_EQUAL_UINT(expected, actual, line, message)                   \
    UnityAssertEqualUintNumber((UNITY_UINT)(expected), (UNITY_UINT)(actual), (message), \
...
#define UNITY_TEST_ASSERT_NOT_EQUAL_INT(threshold, actual, line, message)                         \
    UnityAssertIntGreaterOrLessOrEqualNumber((UNITY_INT)(threshold), (UNITY_INT)(actual),         \
...
#define UNITY_TEST_ASSERT_NOT_EQUAL_UINT(threshold, actual, line, message)                         \
    UnityAssertUintGreaterOrLessOrEqualNumber((UNITY_UINT)(threshold), (UNITY_UINT)(actual),       \
                                              UNITY_NOT_EQUAL, (message), (UNITY_LINE_TYPE)(line), \
...
#define UNITY_TEST_ASSERT_NOT_EQUAL_UINT8(threshold, actual, line, message)                       \
    UnityAssertUintGreaterOrLessOrEqualNumber(                                                    \
        (UNITY_UINT)(UNITY_UINT8)(threshold), (UNITY_UINT)(UNITY_UINT8)(actual), UNITY_NOT_EQUAL, \
...
#define UNITY_TEST_ASSERT_NOT_EQUAL_UINT16(threshold, actual, line, message)       \
    UnityAssertUintGreaterOrLessOrEqualNumber(                                     \
        (UNITY_UINT)(UNITY_UINT16)(threshold), (UNITY_UINT)(UNITY_UINT16)(actual), \
...
#define UNITY_TEST_ASSERT_NOT_EQUAL_UINT32(threshold, actual, line, message)       \
    UnityAssertUintGreaterOrLessOrEqualNumber(                                     \
        (UNITY_UINT)(UNITY_UINT32)(threshold), (UNITY_UINT)(UNITY_UINT32)(actual), \
...
#define UNITY_TEST_ASSERT_INT_WITHIN(delta, expected, actual, line, message)                    \
    UnityAssertIntNumbersWithin((delta), (UNITY_INT)(expected), (UNITY_INT)(actual), (message), \
                                (UNITY_LINE_TYPE)(line), UNITY_DISPLAY_STYLE_INT)
#define UNITY_TEST_ASSERT_INT8_WITHIN(delta, expected, actual, line, message)            \
    UnityAssertIntNumbersWithin((UNITY_UINT8)(delta), (UNITY_INT)(UNITY_INT8)(expected), \
                                (UNITY_INT)(UNITY_INT8)(actual), (message),              \
                                (UNITY_LINE_TYPE)(line), UNITY_DISPLAY_STYLE_INT8)
#define UNITY_TEST_ASSERT_INT16_WITHIN(delta, expected, actual, line, message)             \
    UnityAssertIntNumbersWithin((UNITY_UINT16)(delta), (UNITY_INT)(UNITY_INT16)(expected), \
                                (UNITY_INT)(UNITY_INT16)(actual), (message),               \
                                (UNITY_LINE_TYPE)(line), UNITY_DISPLAY_STYLE_INT16)
#define UNITY_TEST_ASSERT_INT32_WITHIN(delta, expected, actual, line, message)             \
    UnityAssertIntNumbersWithin((UNITY_UINT32)(delta), (UNITY_INT)(UNITY_INT32)(expected), \
                                (UNITY_INT)(UNITY_INT32)(actual), (message),               \
                                (UNITY_LINE_TYPE)(line), UNITY_DISPLAY_STYLE_INT32)
#define UNITY_TEST_ASSERT_UINT_WITHIN(delta, expected, actual, line, message)                      \
    UnityAssertUintNumbersWithin((delta), (UNITY_UINT)(expected), (UNITY_UINT)(actual), (message), \
                                 (UNITY_LINE_TYPE)(line), UNITY_DISPLAY_STYLE_UINT)
...
#define UNITY_TEST_ASSERT_EQUAL_PTR(expected, actual, line, message)                               \
    UnityAssertEqualIntNumber((UNITY_PTR_TO_INT)(expected), (UNITY_PTR_TO_INT)(actual), (message), \
...
#define UNITY_TEST_ASSERT_EQUAL_STRING_LEN(expected, actual, len, line, message)                   \
    UnityAssertEqualStringLen((const char*)(expected), (const char*)(actual), (UNITY_UINT32)(len), \
